...
$fileLocation = Join-Path $toolsDir 'TechnicalStationInstaller.exe'
...
$packageArgs = @{
  ...
  softwareName  = 'Caretag Technical*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
Write-Output $($packageArgs['silentArgs'])
